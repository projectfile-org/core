...
![Project status](https://badges.kiota.ch/static/v1?label=status&message=maintained&color=1d63ed&style=flat-square) [![Last commit on kiota.ch](https://badges.kiota.ch/gitea/last-commit/projectfile/core?gitea_url=https://kiota.ch&style=flat-square)](https://kiota.ch/projectfile/core) [![Latest release](https://badges.kiota.ch/gitea/v/release/projectfile/core?gitea_url=https://codeberg.org&style=flat-square)](https://codeberg.org/projectfile/core/releases)
