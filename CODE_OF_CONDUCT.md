...
We pledge to make participation in [Projectfile Core Go Library](README.md) welcoming, safe, and
...
when an individual is officially representing [Projectfile Core Go Library](README.md) in public
spaces.
