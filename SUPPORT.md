...
Thanks for using **Projectfile Core Go Library**!
...
4. **Environment** — OS, version of Projectfile Core Go Library, runtime version.
...
Paid support for Projectfile Core Go Library is available:
